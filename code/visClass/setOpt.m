...
% opt.catDirs = {'bar','pie'};
% opt.baseDir = 'C:\CodeV2\imagesNew\';
opt.catDirs = {'AreaGraph', 'BarGraph', 'LineGraph', 'Map', 'ParetoChart', 'PieChart', 'RadarPlot', 'ScatterGraph', 'Table', 'VennDiagram'};
% opt.catDirs = { 
%     'AreaGraph\', ...         %1
%     'BarGraph\', ...          %2
%     'BoxPlot\', ...           %3
